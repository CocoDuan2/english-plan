            ...
            if 'phonics-1' in root:
                ...
                if canvas_match:
                    ...
                    if size == 280:
                        ...
                        phonics_1_canvas.append(f"{path}: Canvas {size}px (应为280px)")
...
print(f"  ✅ Phonics 1 Canvas尺寸: {stats['Canvas尺寸正确']}/26")
...
if phonics_1_canvas:
    print(f"\n⚠️  Phonics 1 Canvas尺寸问题：")
    for issue in phonics_1_canvas:
        print(f"  - {issue}")
